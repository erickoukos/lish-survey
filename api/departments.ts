...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('Departments API called:', req.method, req.url, new Date().toISOString())
  ...
  if (req.method === 'GET') {
    try {
      console.log('Processing GET request for departments')
      ...
      console.log('Returning department data:', response)
