  ...
  try {
    ...
    const response = await prisma.surveyResponse.create({
      data: {
        ...
        financeWellnessNeeds: data.financeWellnessNeeds || [],
        cultureWellnessNeeds: data.cultureWellnessNeeds || [],
        cultureWellnessOther: data.cultureWellnessOther,
        digitalSkillsNeeds: data.digitalSkillsNeeds || [],
        digitalSkillsOther: data.digitalSkillsOther,
        professionalDevNeeds: data.professionalDevNeeds || [],
