  ...
  try {
    ...
    const csvData = responses.map(response => {
      ...
      return {
        ...
        urgent_trainings: response.urgentTrainings.join('; '),
        urgent_trainings_other: response.urgentTrainingsOther || '',
        finance_wellness_needs: response.financeWellnessNeeds.join('; '),
        culture_wellness_needs: response.cultureWellnessNeeds.join('; '),
        culture_wellness_other: response.cultureWellnessOther || '',
        digital_skills_needs: response.digitalSkillsNeeds.join('; '),
        digital_skills_other: response.digitalSkillsOther || '',
        professional_dev_needs: response.professionalDevNeeds.join('; '),
        ...
        observed_issues: response.observedIssues.join('; '),
